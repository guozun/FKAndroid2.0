...
public class FakeRefreshListView extends HandyListView
{
	...
	public FakeRefreshListView(Context context) {
		super(context);
		init();
	}

	public FakeRefreshListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public FakeRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
