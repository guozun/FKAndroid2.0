...
public class SelectCityByProvince extends BaseActivity
{
    ...
    private HashMap<String, Integer> alphaIndexer;// 存放存在的省份和与之对应的列表位置

    private String[] sections;// 存放存在的省份名称
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        mCityNames = getCityNamesByProvnice();
        letterListView
    ...
    private ArrayList<City> getCityNamesByProvnice()
    {
        ArrayList<City> names = new ArrayList<City>();
        Cursor cursor = database.rawQuery(
                "SELECT * FROM cities ORDER BY ProvinceSort", null);
    ...
    private class ListAdapter extends BaseAdapter
    {
        ...
        public ListAdapter(Context context, List<City> list)
        {
            ...
            for (int i = 0; i < list.size(); i++)
            {
                ...
                {  	
                		String name = list.get(i).getProvinceSort();
