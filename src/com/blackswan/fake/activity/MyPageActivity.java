	...
	protected void initViews() {
		...
		mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
			...
			public void onPageSelected(int arg0) {
	            ...
	            Animation animation = new TranslateAnimation(currIndex * mScreenWidth/3, arg0  
	                    * mScreenWidth/3, 0, 0);  
	            currIndex = arg0;  
...
//		RelativeLayout.LayoutParams parms = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
		RelativeLayout.LayoutParams parms = new RelativeLayout.LayoutParams(mScreenWidth/3,Utility.Dp2Px(this, 5));
